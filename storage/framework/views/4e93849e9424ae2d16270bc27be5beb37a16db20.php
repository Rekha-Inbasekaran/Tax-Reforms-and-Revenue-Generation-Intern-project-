...
<body id="app-layout">
  ...
  <thead>
      <tr>
        ...
        <th class="th-sm">Collectiondate</th>
        <th class="th-sm">Collectionamount</th>
        <th class="th-sm">Arrearamount</th>
      </tr>
...
<td><?php echo e($user->collectiondate); ?></td>
<td><?php echo e($user->collectionamount); ?></td>
<td><?php echo e($user->arrearcollection); ?></td>
</tr>
<?php endforeach; ?>
<?php endif; ?>
